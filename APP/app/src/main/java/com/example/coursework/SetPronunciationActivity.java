...
public class SetPronunciationActivity extends AppCompatActivity implements NavigationMenu {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sayWord = findViewById(R.id.textSay);
        word = getIntent().getStringExtra("word");
        sayWord.setText(word);
            ...
            public boolean onTouch(View v, MotionEvent event) {
                if(event.getAction() == MotionEvent.ACTION_DOWN){
                    ...
                    if(isRecording){
                        ...
                        Intent intent = new Intent(SetPronunciationActivity.this, ResultActivity.class);
    ...
    public void ClickTrain(View view){
        redirectActivity(this, RandomPronunciationActivity.class);
    }
